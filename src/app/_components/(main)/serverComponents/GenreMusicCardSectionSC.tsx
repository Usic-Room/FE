...
import { GenreMusicCardListCC } from "@/components/(main)/clientComponents/GenreMusicCardListCC";

interface GenreMusicCardSectionSCProps {
  router: string;
...
export async function GenreMusicCardSectionSC({
  router,
  genreMusicResultType,
}: GenreMusicCardSectionSCProps) {
