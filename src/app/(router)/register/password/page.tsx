...
import { SubmitButton } from "@/app/(router)/register/_components/serverComponents";
...
export default function RegisterPassword() {
  ...
  return (
    <div className="flex flex-col items-center max-w-xl mx-auto p-8 bg-white min-h-screen font-pretendard">
      <SpotifyLogo className="mb-6" alt="Spotify Logo" />

      {/* Progress Bar and Sections */}
      <div className="w-full">
        <div className="relative h-1 w-full bg-gray-300 mb-4">
        ...
        <div className="flex">
          ...
          <div className="w-max mr-4">
            <button className="text-black size-7">
          ...
          <div className="flex-grow">
            <p className="text-lg text-purple-600">1/3단계</p>
            <h1 className="text-xl font-bold mb-6">비밀번호를 만드세요.</h1>
