...
} from "@/app/(auth)/login/reset-password/_components/serverComponents";

import { ResetPasswordForm } from "@/app/(auth)/login/reset-password/_components/clientComponents";
