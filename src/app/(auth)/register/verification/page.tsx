...
} from "@/app/(auth)/register/verification/_components/serverComponents";
import { Metadata } from "next";
import { VerificationCodeForm } from "@/app/(auth)/register/verification/_components/clientComponents";
